...
<?php
    ...
    && isset($_POST['password']) && isset($_POST['passconfirm']))
    {
        ...
        if (empty($first_name)) {
            ...
            $result = register($email,$pass,$first_name,$last_name);
            if($result['code']==0)
            {
                ...
                <div id ="ui">
                    ...
                    <form action="" class="form-group" method="post">
                        ...
                        <div class="form-group col-lg-6" >
                            ...
                            <button type="submit" class="btn btn-success px-5 mt-3 mr-2">Tạo mới</button>
                        </div>
